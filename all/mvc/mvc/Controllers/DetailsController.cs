...
namespace WebApplication11.Controllers
{
    public class DetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Books,Signature,Phno")] Details details)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Books,Signature,Phno")] Details details)
        {
            if (id != details.Id)
            {
                return NotFound();
